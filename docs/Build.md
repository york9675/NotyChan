...
- **Xcode** installed (requires macOS 14 or higher to support development for iOS 17 and above). You can download Xcode from the [App Store](https://apps.apple.com/us/app/xcode/id497799835).
- **iPhone/iPad** (physical device or simulator) requires iOS 17 or higher. If it is a physical machine, please enable "Developer Mode" first.
...
1. **Open Xcode**.
2. **Open the Project**: Navigate to the directory where you cloned/downloaded the project, then open the `NotyChan/src/NotyChan.xcodeproj`.
